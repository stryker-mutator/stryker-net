...
Please [download and install the dotnet 10 runtime](https://dotnet.microsoft.com/en-us/download/dotnet/10.0) and update your pipeline to have the dotnet 10 runtime available.
