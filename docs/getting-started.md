...
Stryker requires the dotnet 5.0 runtime or newer: [Install dotnet](https://dotnet.microsoft.com/download)

\* Note: Your application does not need to be dotnet 5.0 or newer. You only need the runtime installed so stryker can run.
