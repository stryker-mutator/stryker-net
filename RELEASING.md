...
3. Run `npm run prepare-release` from the root of the repo and enter the new version number. This will automatically create a GitHub release for the new tag with the correct release notes from the changelog.
