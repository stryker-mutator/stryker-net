...
namespace IntegrationTests
{
    public class ValidateStrykerResults
    {
        ...
        public void NetStandard()
        {
            ...
            CheckReportMutantCounts(report, total: 25, skipped: 0, survived: 2, killed: 2, timeout: 1, nocoverage: 18);
        }
        ...
        public void NetFullFramework()
        {
            if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
            {
                ...
                CheckReportMutantCounts(report, total: 3, skipped: 0, survived: 1, killed: 2, timeout: 0, nocoverage: 0);
            }
        }
