...
namespace IntegrationTests
{
    public class ValidateStrykerResults
    {
        ...
        public void NetCoreWithTwoTestProjects()
        {
            ...
            CheckReportMutantCounts(report, total: 103, ignored: 6, survived: 9, killed: 12, timeout: 2, nocoverage: 73);
        }
        ...
        public void SolutionRun()
        {
            ...
            CheckReportMutantCounts(report, total: 106, ignored: 36, survived: 4, killed: 12, timeout: 2, nocoverage: 50);
        }
