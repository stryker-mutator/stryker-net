    ...
    public class OptionsBuilder
    {
            ...
            CommandOption dashboardCompareFileExcludePatterns)
        {
            ...
            return new StrykerOptions(
                ...
                dashboardApiKey: GetOption(dashboardApiKey.Value(), CLIOptions.DashboardApiKey),
                dashboardUrl: GetOption(dashboardUrl.Value(), CLIOptions.DashboardUrl),
                diffIgnoreFiles: GetOption(dashboardCompareFileExcludePatterns.Value(), CLIOptions.DiffIgnoreFiles),
                projectName: GetOption(reportersProjectName.Value(), CLIOptions.DashboardProjectName),
                moduleName: GetOption(reportersModuleName.Value(), CLIOptions.DashboardModuleName),
                projectVersion: GetOption(reportersProjectVersion.Value(), CLIOptions.DashboardProjectVersion),
                fallbackVersion: GetOption(fallbackVersion.Value(), CLIOptions.DashboardFallbackVersion),
                ...
                languageVersion: GetOption(languageVersion.Value(), CLIOptions.LangVersion),
