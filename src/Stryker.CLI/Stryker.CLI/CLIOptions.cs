...
namespace Stryker.CLI
{
    public static class CLIOptions
    {
        ...
        public static readonly CLIOption<string> SolutionPath = new CLIOption<string>
        {
            ...
            ArgumentDescription = "Full path to your solution file. The solution file is needed to build the project and resolve dependencies for .net framework but can optionally be used for .net core. Path can be relative from test project or full path.",
            DefaultValue = null,
