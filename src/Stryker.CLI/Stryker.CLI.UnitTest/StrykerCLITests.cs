...
Options:";
    ...
    public async Task ShouldDisplayLogoWithInfoVerbosity()
    {
        ...
        await target.RunAsync(new[] { "--verbosity", "info", "--skip-version-check" });
    ...
    public async Task ShouldDisplayLogoWithTraceVerbosity()
    {
        ...
        await target.RunAsync(new[] { "--verbosity", "trace", "--skip-version-check" });
    ...
    public async Task ShouldNotDisplayLogoWithWarningVerbosity()
    {
        ...
        await target.RunAsync(new[] { "--verbosity", "warning", "--skip-version-check" });
    ...
    public async Task ShouldNotDisplayLogoWithErrorVerbosity()
    {
        ...
        await target.RunAsync(new[] { "--verbosity", "error", "--skip-version-check" });
