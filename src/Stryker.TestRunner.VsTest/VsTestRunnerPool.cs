...
public sealed class VsTestRunnerPool : ITestRunner
{
    ...
    /// <summary>
    /// No-op for VSTest runner since each test run starts a fresh process
    /// that automatically loads the current (mutated) assembly.
    /// </summary>
    public Task ReloadMutatedAssemblyAsync() => Task.CompletedTask;
