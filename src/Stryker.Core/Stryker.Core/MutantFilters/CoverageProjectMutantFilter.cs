...
{
    public class CoverageProjectMutantFilter : IProjectMutantFilter
    {
        private readonly MutationTestInput _input;
        private readonly ILogger<CoverageProjectMutantFilter> _logger;
        private readonly IMutationTestExecutor _mutationTestExecutor;
        private readonly StrykerOptions _options;

        public CoverageProjectMutantFilter(StrykerOptions options, IMutationTestExecutor mutationTestExecutor, MutationTestInput input)
        {
            _input = input;
            _mutationTestExecutor = mutationTestExecutor;
            _options = options;

            _logger = ApplicationLogging.LoggerFactory.CreateLogger<CoverageProjectMutantFilter>();
        }
        ...
        public void FilterMutants()
        {
            ...
            var mutantsToScan = _input.ProjectInfo.ProjectContents.Mutants.Where(x => x.ResultStatus != MutantStatus.Ignored).ToList();
