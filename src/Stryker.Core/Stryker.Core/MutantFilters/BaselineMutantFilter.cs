...
public class BaselineMutantFilter : IMutantFilter
{
    ...
    public BaselineMutantFilter(IStrykerOptions options, IBaselineProvider baselineProvider = null, IGitInfoProvider gitInfoProvider = null, IBaselineMutantHelper baselineMutantHelper = null)
    {
    ...
    private void UpdateMutantsWithBaselineStatus(IEnumerable<IMutant> mutants, IReadOnlyFileLeaf file)
    {
        ...
        if (baselineFile is { })
        {
            foreach (var baselineMutant in baselineFile.Mutants)
            {
                ...
                IEnumerable<IMutant> matchingMutants = _baselineMutantHelper.GetMutantMatchingSourceCode(mutants, baselineMutant, baselineMutantSourceCode);
    ...
    private void SetMutantStatusToBaselineMutantStatus(JsonMutant baselineMutant, IEnumerable<IMutant> matchingMutants)
    {
