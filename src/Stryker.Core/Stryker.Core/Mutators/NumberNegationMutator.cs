...
public class NumberNegationMutator : MutatorBase<LiteralExpressionSyntax>
{
    ...
    {
        if (IsNumberLiteral(node) && node.Token.Value is not null)
        {
            var currentValue = (int)node.Token.Value;
