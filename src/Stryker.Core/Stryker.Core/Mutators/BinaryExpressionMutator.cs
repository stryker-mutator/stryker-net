...
public class BinaryExpressionMutator : MutatorBase<BinaryExpressionSyntax>
{
    ...
    public override IEnumerable<IMutation> ApplyMutations(BinaryExpressionSyntax node, SemanticModel semanticModel)
    {
    ...
    private static IMutation GetLogicalMutation(BinaryExpressionSyntax node)
    {
    ...
    private static IMutation GetIntegralMutation(ExpressionSyntax node)
    {
