...
public interface IMutationTestExecutor
{
    ...
    void Test(IProjectAndTests project, IList<IMutant> mutantsToTest, ITimeoutValueCalculator timeoutMs, ITestRunner.TestUpdateHandler updateHandler);
}
...
public class MutationTestExecutor : IMutationTestExecutor
{
    ...
    public void Test(IProjectAndTests project, IList<IMutant> mutantsToTest, ITimeoutValueCalculator timeoutMs, ITestRunner.TestUpdateHandler updateHandler)
    {
    ...
    private ITestRunResult RunTestSession(IProjectAndTests projectAndTests, ICollection<IMutant> mutantsToTest,
        ...
        ITestRunner.TestUpdateHandler updateHandler, bool forceSingle)
    {
