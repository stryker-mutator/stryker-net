...
public class InputFileResolver : IInputFileResolver
{
    ...
    private List<IAnalyzerResult> AnalyzeSolution(IStrykerOptions options)
    {
    ...
    private IReadOnlyCollection<SourceProjectInfo> BuildProjectInfos(IStrykerOptions options,
    ...
    public string FindSourceProject(IEnumerable<IAnalyzerResult> testProjects, IStrykerOptions options)
    {
    ...
    internal string DetermineSourceProjectWithNameFilter(IStrykerOptions options, IReadOnlyCollection<string> projectReferences)
    {
