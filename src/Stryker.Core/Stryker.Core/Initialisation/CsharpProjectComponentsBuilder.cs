...
public class CsharpProjectComponentsBuilder : ProjectComponentsBuilder
{
    ...
    /// Deprecated method, should not be maintained
    /// </summary>
    private CsharpFolderComposite FindInputFiles(string path, string sourceProjectDir, IAnalyzerResult analyzerResult, IStrykerOptions options)
    {
    ...
    private static CSharpParseOptions BuildCsharpParseOptions(IAnalyzerResult analyzerResult, IStrykerOptions options) => new(options.LanguageVersion, DocumentationMode.None, preprocessorSymbols: analyzerResult.PreprocessorSymbols);
