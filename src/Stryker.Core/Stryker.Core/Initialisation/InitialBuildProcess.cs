...
public class InitialBuildProcess : IInitialBuildProcess
{
    ...
    public void InitialBuild(bool fullFramework, string projectPath, string solutionPath, string msbuildPath = null)
    {
        ...
        if (fullFramework)
        {
            ...
            {
                throw new Shared.Exceptions.InputException("Stryker could not build your project as no solution file was presented. Please pass the solution path to stryker.");
            }
