...
public class InitialisationProcess : IInitialisationProcess
{
    ...
    public IReadOnlyCollection<MutationTestInput> GetMutationTestInputs(IStrykerOptions options, IReadOnlyCollection<SourceProjectInfo> projects, ITestRunner runner)
    {
