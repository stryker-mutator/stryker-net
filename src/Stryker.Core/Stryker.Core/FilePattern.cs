...
/// </summary>
public sealed class FilePattern : IFilePattern
{
    ...
    public static IFilePattern Parse(string pattern)
    {
    ...
    public bool Equals(IFilePattern other) =>
        Glob.ToString() == other.Glob.ToString() && IsExclude == other.IsExclude && TextSpans.SequenceEqual(other.TextSpans);
