...
public class StrykerOptions : IStrykerOptions
{
    ...
    /// </summary>
    public IEnumerable<IFilePattern> Mutate { get; init; } = new[] { FilePattern.Parse("**/*") };
    ...
    public IStrykerOptions Copy(string projectPath, string workingDirectory, string sourceProject, IEnumerable<string> testProjects) => new StrykerOptions()
    {
        _parentOptions = this,
