...
namespace Stryker.Core.Options
{
    public interface IStrykerInputs
    {
        ...
        TargetProjectNameInput TargetProjectNameInput { get; init; }
    ...
    public class StrykerInputs : IStrykerInputs
    {
        ...
        public TargetProjectNameInput TargetProjectNameInput { get; init; } = new();
        ...
        public StrykerOptions ValidateAll()
        {
            ...
            _strykerOptionsCache ??= new StrykerOptions()
            {
                ...
                SourceProjectName = TargetProjectNameInput.Validate(),
