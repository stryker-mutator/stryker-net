...
* **Solution path exception:** Clear error message on solution path missing ([#527](https://github.com/stryker-mutator/stryker-net/issues/527)) ([d2522d8](https://github.com/stryker-mutator/stryker-net/commit/d2522d8))
