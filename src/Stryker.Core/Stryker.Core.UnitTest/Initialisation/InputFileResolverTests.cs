...
namespace Stryker.Core.UnitTest.Initialisation
{
    ...
    <PropertyGroup>
        ...
        public void InitializeShouldFindFilesRecursively()
        {
            ...
            projectFileReaderMock.Setup(x => x.AnalyzeProject(testProjectPath, null, null, It.IsAny<AnalyzerOption>()))
                .Returns(TestHelper.SetupProjectAnalyzerResult(
                projectReferences: new List<string> { projectUnderTestPath },
                targetFramework: "netcoreapp2.1",
                projectFilePath: testProjectPath,
                references: new string[] { "" }).Object);
            projectFileReaderMock.Setup(x => x.AnalyzeProject(projectUnderTestPath, null, null, It.IsAny<AnalyzerOption>()))
                .Returns(TestHelper.SetupProjectAnalyzerResult(
...
<Project Sdk=""Microsoft.NET.Sdk"">
    ...
    <ItemGroup>
        ...
        public void InitializeShouldIgnoreBinFolder(string folderName)
        {
            ...
            var projectFileReaderMock = new Mock<IProjectFileReader>(MockBehavior.Strict);
            projectFileReaderMock.Setup(x => x.AnalyzeProject(It.IsAny<string>(), It.IsAny<string>(), null, It.IsAny<AnalyzerOption>()))
                .Returns(TestHelper.SetupProjectAnalyzerResult(
                    projectReferences: new List<string> { projectUnderTestPath },
                    targetFramework: "netcoreapp2.1",
                    projectFilePath: testProjectPath,
...
";
        ...
        public void ShouldFindAllTestProjects()
        {
            ...
            projectFileReaderMock.Setup(x => x.AnalyzeProject(It.IsAny<string>(), null, null, It.IsAny<AnalyzerOption>()))
                .Returns(TestHelper.SetupProjectAnalyzerResult(
                    projectReferences: new List<string> { projectUnderTestPath },
                    targetFramework: "netcoreapp2.1",
