...
namespace Stryker.Core.UnitTest.Initialisation
{
    public class InitialTestProcessTests : TestBase
    {
        ...
        public void InitialTestProcess_ShouldNotThrowIfAFewTestsFail()
        {
            ...
            testRunnerMock.Setup(x => x.InitialTest(It.IsAny<IProjectAndTest>())).Returns(new TestRunResult(Enumerable.Empty<VsTestDescription>(), ranTests, failedTests, TestGuidsList.NoTest(), string.Empty, TimeSpan.Zero) );
