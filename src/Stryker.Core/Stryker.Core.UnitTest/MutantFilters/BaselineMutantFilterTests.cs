...
public class BaselineMutantFilterTests : TestBase
{
    ...
    public void GetBaseline_UsesBaselineFallbackVersion_WhenReportForCurrentVersionNotFound()
    {
        ...
        _ = gitInfoProvider.Setup(x => x.GetCurrentBranchName()).Returns(branchName);

        _ = baselineProvider.Setup(x => x.Load($"baseline/{branchName}")).Returns(Task.FromResult<JsonReport>(null));
        _ = baselineProvider.Setup(x => x.Load($"baseline/{options.FallbackVersion}")).Returns(Task.FromResult(jsonReport));
    ...
    public void GetBaseline_UsesFallbackVersion_WhenBaselineFallbackVersionNotFound()
    {
        ...
        _ = baselineProvider.Setup(x => x.Load(branchName)).Returns(Task.FromResult<JsonReport>(null));
        _ = baselineProvider.Setup(x => x.Load($"baseline/{options.FallbackVersion}")).Returns(Task.FromResult<JsonReport>(null));
        _ = baselineProvider.Setup(x => x.Load(options.FallbackVersion)).Returns(Task.FromResult(jsonReport));
    ...
    public void GetBaseline_UsesCurrentVersionReport_IfReportExists()
    {
        ...
        _ = baselineProvider.Setup(x => x.Load($"baseline/{branchName}")).Returns(Task.FromResult(jsonReport));
    ...
    public void FilterMutants_WhenMutantSourceCodeIsNull_MutantIsReturned()
    {
        ...
        _ = baselineProvider.Setup(mock => mock.Load(It.IsAny<string>()))
            .Returns(Task.FromResult((JsonReport)baseline));

        _ = baselineMutantHelper.Setup(mock => mock.GetMutantSourceCode(It.IsAny<string>(), It.IsAny<JsonMutant>())).Returns(string.Empty);
    ...
    public void FilterMutants_WhenMutantMatchesSourceCode_StatusIsSetToJsonMutant()
    {
        ...
        _ = baselineMutantHelper.Setup(mock => mock.GetMutantSourceCode(It.IsAny<string>(), It.IsAny<JsonMutant>())).Returns("var foo = \"bar\";");
    ...
    public void ShouldNotUpdateMutantsWithBaselineIfFileNotInBaseline()
    {
        ...
        _ = baselineProvider.Setup(mock => mock.Load(It.IsAny<string>())).Returns(Task.FromResult((JsonReport)baseline));
