...
namespace Stryker.Core.UnitTest.Options.Inputs
{
    public class BaselineCreateEnabledInputTests : TestBase
    {
        ...
        {
            var target = new BaselineRereateEnabledInput();
        ...
        {
            var target = new BaselineRereateEnabledInput { SuppliedInput = true };
        ...
        {
            var target = new BaselineRereateEnabledInput { SuppliedInput = false };
