...
namespace Stryker.Core.UnitTest.Options.Inputs
{
    ...
    This argument takes a json array as value. Example: ['string', 'logical'] | default: []");
        ...
        public void ShouldValidateExcludedMutation()
        {
            ...
            ex.Message.ShouldBe($"Invalid excluded mutation (gibberish). The excluded mutations options are [Statement, Arithmetic, Block, Equality, Boolean, Logical, Assignment, Unary, Update, Checked, Linq, String, Bitwise, Initializer, Regex, NullCoalescing, Math, Conditional]");
        }
