    ...
    public class MutationTestProcessTests
    {
        ...
        public void ShouldCallMutantOrchestratorAndReporter()
        {
            ...
            var target = new MutationTestProcess(input,
                ...
                fileSystem,
                options,
                new BroadcastMutantFilter(Enumerable.Empty<IMutantFilter>(), null));
        ...
        public void MutateShouldCallMutantFilters()
        {
            ...
            var target = new MutationTestProcess(input,
                ...
                fileSystem,
                options,
                new BroadcastMutantFilter(new[] { mutantFilterMock.Object }, null));
        ...
        public void ShouldNotCallExecutorForNotCoveredMutants()
        {
            ...
            var target = new MutationTestProcess(input,
                reporterMock.Object,
                executorMock.Object,
                mutantFilter: new BroadcastMutantFilter(Enumerable.Empty<IMutantFilter>(), null),
                options: options);
